...
description: >
  ...
  Активується при: "/pechernyi", "печерний режим", "говори коротко", "менше токенів".
---

## ВАЖЛИВО: Цей скіл НЕАКТИВНИЙ за замовчуванням

Правила нижче застосовувати **ТІЛЬКИ** коли в контексті поточного повідомлення є рядок `PECHERNYI MODE ACTIVE`. Цей рядок емітує хук при команді `/pechernyi` або `/pechernyi lite|full|ultra`.

Якщо `PECHERNYI MODE ACTIVE` **немає** — відповідати звичайно, повними реченнями, нормальним стилем. Ігнорувати всі правила нижче.

Якщо є `PECHERNYI MODE DEACTIVATED` — відповідати звичайно, печерний вимкнено.
...
За замовчуванням: **full**. Перемкнути: `/pechernyi lite|full|ultra`. Вимкнути: `/pechernyi off`.
