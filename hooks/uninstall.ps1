# pechernyi — uninstaller for the SessionStart + UserPromptSubmit hooks (Windows PowerShell)
...
#   or:  irm https://raw.githubusercontent.com/Kerber0ss/pechernyi/main/hooks/uninstall.ps1 | iex
param()
...
$FlagFile = Join-Path $ClaudeDir ".pechernyi-active"
...
Write-Host "Uninstalling pechernyi hooks..."
...
if (Test-Path $Settings) {
    if (-not (Get-Command node -ErrorAction SilentlyContinue)) {
        ...
        Write-Host "         Remove the pechernyi SessionStart and UserPromptSubmit"
...
Write-Host "  npx skills remove pechernyi      # Cursor, Windsurf, Cline, Copilot, etc."
Write-Host "  claude plugin disable pechernyi   # Claude Code plugin"
Write-Host "  gemini extensions uninstall pechernyi  # Gemini CLI"
